	...
	<colgroup>
		...
		<tr>
			...
			<td>
				<div class="row">
					<div class="col-auto">
						<input type="text" class="form-control" name="last_name" required value="${vo.last_name}">
					</div>
					<div class="col-auto">
		...
		<tr>
			...
			<td>
				<div class="row">
					<div class="col-auto">
						<input type="text" class="form-control" name="email" required value="${vo.email}">
					</div>
				</div>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<div class="row">
					<div class="col-auto">
						<input type="text" class="form-control" name="salary" required value="${vo.salary}">
					</div>
				</div>
			</td>
		</tr>
