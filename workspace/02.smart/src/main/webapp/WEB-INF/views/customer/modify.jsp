...
<body>
	...
	<input type="hidden" name="id" value="${vo.id}">
			...
			<tr>
				...
				<td>
					<div class="form-check form-check-inline" >
						<input class="form-check-input" type="radio" name="gender" id="gender" value="남" ${vo.gender eq "남" ? "checked":"" }> 
		...
		<div class="btn-toolbar gap-3 my-3 justify-content-center">
			<button class="btn btn-primary">저장</button>
			<button type="button" class="btn btn-outline-primary"
			 		onclick="history.go(-1)">취소</button>
	   <%-- <button type="button" class="btn btn-outline-primary"
			 	    onclick="location='info.cu?id=${vo.id}'">취소</button> --%>
		</div>
	</form>
